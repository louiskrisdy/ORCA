<x-guest-layout>
    <main class="grid grid-cols-4 gap-8 mt-8 wrapper">
        ...
        <aside class="flex flex-col items-center h-full p-4 space-y-4 bg-white shadow">
            ...
            <div class="text-xs">
                <h2 class="font-bold" style="color: #283044;">Join Date:</h2>
            ...
            <div class="flex flex-col pt-8 space-y-2">
                ...
                <span class="px-2 py-1 text-sm text-white rounded" style="background: #283044;">
        ...
        <section class="flex flex-col col-span-3 gap-y-4">
            ...
            <span class="w-full p-2 font-bold bg-white rounded shadow" style="color: #283044;">
                Latest Threads
            </span>
