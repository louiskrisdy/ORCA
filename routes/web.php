...
// Profile
Route::get('profile/user/{user:name}', [ProfileController::class, 'show'])->name('profile');

// Follows
Route::post('profile/user/{user:name}/follow', [FollowController::class, 'store'])->name('follow');
